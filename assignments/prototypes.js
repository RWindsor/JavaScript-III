...
function GameObject(character) {
  ...
  this.dimensions = character.dimsensions;
}
...
function Humanoid (human){
  ...
  greet.prototype = Object.create(CharacterStats.prototype);
}
GameObject.prototype.greet = function (){
  return `${GameObject.prototype.name} offers a greeting in the ${Humanoid.prototype.language}.`;
}
